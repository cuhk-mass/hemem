...
libhemem.so: hemem.o hemem-mmgr.o timer.o interpose.o
	$(CC) $(LDFLAGS) -o libhemem.so hemem.o timer.o hemem-mmgr.o interpose.o $(HEMEM_LIBS)

libhemem-lru.so: hemem-lru.o lru.o timer.o interpose.o
	$(CC) $(LDFLAGS) -o libhemem-lru.so hemem-lru.o timer.o lru.o interpose.o $(HEMEM_LIBS)

libhemem-simple.so: hemem-simple.o simple.o timer.o interpose.o
	$(CC) $(LDFLAGS) -o libhemem-simple.so hemem-simple.o timer.o simple.o interpose.o $(HEMEM_LIBS)

libhemem-lru-swap.so: hemem-lru-swap.o lru_swap.o timer.o interpose.o
	$(CC) $(LDFLAGS) -o libhemem-lru-swap.so hemem-lru-swap.o timer.o lru_swap.o interpose.o $(HEMEM_LIBS)

hemem.o: hemem.c hemem.h hemem-mmgr.h interpose.h
	$(CC) $(CFLAGS) $(INCLUDES) -D ALLOC_HEMEM -c hemem.c -o hemem.o

hemem-lru.o: hemem.c hemem.h lru.h interpose.h
	$(CC) $(CFLAGS) $(INCLUDES) -D ALLOC_LRU -c hemem.c -o hemem-lru.o

hemem-simple.o: hemem.c hemem.h simple.h interpose.h
	$(CC) $(CFLAGS) $(INCLUDES) -D ALLOC_SIMPLE -c hemem.c -o hemem-simple.o

hemem-lru-swap.o: hemem.c hemem.h lru.h interpose.h
