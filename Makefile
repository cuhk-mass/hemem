...
libhemem.so: hemem.o pebs.o timer.o interpose.o fifo.o coalesce.o
	$(CC) $(LDFLAGS) -o libhemem.so hemem.o timer.o interpose.o pebs.o fifo.o coalesce.o $(HEMEM_LIBS)

libhemem-lru.so: hemem-lru.o lru.o timer.o interpose.o paging.o fifo.o coalesce.o
	$(CC) $(LDFLAGS) -o libhemem-lru.so hemem-lru.o timer.o lru.o interpose.o paging.o fifo.o coalesce.o $(HEMEM_LIBS)

libhemem-simple.so: hemem-simple.o simple.o timer.o interpose.o paging.o fifo.o coalesce.o
	$(CC) $(LDFLAGS) -o libhemem-simple.so hemem-simple.o timer.o simple.o interpose.o paging.o fifo.o coalesce.o $(HEMEM_LIBS)

libhemem-lru-swap.so: hemem-lru-swap.o lru_swap.o timer.o interpose.o paging.o fifo.o coalesce.o
	$(CC) $(LDFLAGS) -o libhemem-lru-swap.so hemem-lru-swap.o timer.o lru_swap.o interpose.o paging.o fifo.o coalesce.o $(HEMEM_LIBS)
